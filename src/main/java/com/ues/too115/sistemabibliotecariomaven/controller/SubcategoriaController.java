...
public class SubcategoriaController {
    ...
    @RequestMapping(value = "subcategoriaList", method = RequestMethod.GET)
...
//        SubcategoriaId id = new SubcategoriaId(Integer.parseInt(request.getParameter("id")), Integer.parseInt(idCategoriaString));
    ...
    @RequestMapping(value = "subcategoriaAdd", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "subcategoriaDelete",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "subcategoriaByCategoria")
